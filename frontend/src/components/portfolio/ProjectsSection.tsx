...
function ProjectCard({
  ...
  return (
    <div
      className="sticky top-24 md:top-32 h-[85vh] flex items-center justify-center px-4 sm:px-6 md:px-10"
      style={{ top: `${index * 28}px` }}
    >
      <motion.div
        style={{ scale }}
        className="w-full max-w-7xl rounded-[40px] sm:rounded-[50px] md:rounded-[60px] border-2 border-[#D7E2EA] p-4 sm:p-6 md:p-8"
      >
        <div
          className="rounded-[36px] sm:rounded-[44px] md:rounded-[52px] p-4 sm:p-6 md:p-8"
...
export function ProjectsSection() {
  ...
  return (
    <section
      id="projects"
      className="relative z-10 -mt-10 sm:-mt-12 md:-mt-14 rounded-t-[40px] sm:rounded-t-[50px] md:rounded-t-[60px] pt-20 sm:pt-24 md:pt-32 pb-32"
