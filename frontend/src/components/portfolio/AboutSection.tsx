  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center gap-10 sm:gap-14 md:gap-16">
        ...
        <AnimatedText
          text="I'm Sibasis, a software developer focused on building modern, performant, and beautifully animated web apps with React, TypeScript, Tailwind, and Motion. I care about clean code, thoughtful UX, and shipping products that feel great to use."
